...
public interface IJob {
	...
	public void addArticles(String login, String psw, int idArticle, int Quantity); 	//Ajouter un article au panier
	...
	public void valideCart(String login, String psw);									//Valider la commande
